...
import { getProductQuantity } from '../../helpers/functions';
...
export const Category: React.FC<Props> = ({ isLoading, products }) => {
  if (isLoading) {
    return (
      ...
      <div className="container">
        ...
        <div className="category__container">
          {categories.map(category => {
            ...
            const quantity = getProductQuantity(type, products);
