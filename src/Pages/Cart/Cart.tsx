                    ...
                    <div className="cart__item" key={id}>
                      <div className="cart__left-box">
                        <button
                          ...
                          type="button"
                          onClick={
                            (event) => handleClick(event, 'delete', item)
                          }
                        >
                          <img
                        ...
                        <div className="cart__chose-item">
                          <Link
                            to={{
                      ...
                      <div className="cart__right-box">
                        <div className="cart__quantity-box">
                          <button
                            ...
                            type="button"
                            onClick={
                              (event) => handleClick(event, 'subtract', item)
                            }
                          >
                            <img
                          ...
                          <button
                            ...
                            type="button"
                            onClick={(event) => handleClick(event, 'add', item)}
                          >
