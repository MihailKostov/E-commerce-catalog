...
import { getProductsByType } from '../../helpers/getProductsByTypes';
...
import { Pagitation } from '../../Components/Pagitation/Pagitation';
...
export const CatalogePage: React.FC<Props> = ({ product }) => {
  ...
  if (isError) {
    return (
      <main className="page__main catalog">
        <Error />
      </main>
    );
  }
